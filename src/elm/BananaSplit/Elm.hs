...
generateElmFiles = do
  ...
  generateElmModuleWith
    ...
    , DefineElm (Proxy :: Proxy RequestCodeParams)
    ...
    , DefineElm (Proxy :: Proxy ResumenConsolidado)
    , DefineElm (Proxy :: Proxy ConsolidacionParams)
    , DefineElm (Proxy :: Proxy FreezeParams)
    , DefineElm (Proxy :: Proxy (Netos Monto))
    , DefineElm (Proxy :: Proxy (PorMoneda (Netos Monto)))
    , DefineElm (Proxy :: Proxy Moneda)
    , DefineElm (Proxy :: Proxy MetricasGrupo)
    , DefineElm (Proxy :: Proxy MetricasPorMoneda)
    , DefineElm (Proxy :: Proxy BigOne)
    , DefineElm (Proxy :: Proxy BusiestMes)
    , DefineElm (Proxy :: Proxy BusiestDia)
