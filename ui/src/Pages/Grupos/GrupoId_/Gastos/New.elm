module Pages.Grupos.GrupoId_.Gastos.New exposing (Model, Msg, page)

{-| Crear un gasto dejó de ser una pantalla y pasó a ser el popup sobre la lista
de gastos. Esta página solo existe para que los links viejos —los que alguien
compartió o tiene en favoritos— sigan llegando a algún lado, y redirige apenas
se monta.
