...
jsonDecTransaccion =
   Json.Decode.succeed (\ptransaccionId ptransaccionFrom ptransaccionTo ptransaccionMonto -> {transaccionId = ptransaccionId, transaccionFrom = ptransaccionFrom, transaccionTo = ptransaccionTo, transaccionMonto = ptransaccionMonto})
   |> fnullable "transaccionId" (jsonDecULID)
...
jsonEncTransaccion  val =
   Json.Encode.object
   [ ("transaccionId", (maybeEncode (jsonEncULID)) val.transaccionId)
